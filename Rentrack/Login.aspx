...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
 ...
 /*Form input css*/
        ...
        button.btn:focus { outline: 0; opacity: 0.6; background: #eda136; color: #fff; }

        button.btn:active:focus, button.btn.active:focus { outline: 0; opacity: 0.6; background: #eda136; color: #fff; }
	</style>
                        ...
                        <div class="col-sm-6 col-sm-offset-3 form-box">
                            ...
                            <div class="form-bottom">
			                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                    <asp:Button id="loginbtn" runat="server" class= "btn" OnClick="Login_btn" Text="Login" />
                            ...
                            <div class="col-sm-6 col-sm-offset-3 new-user">
                        	    <h2>Are you a New User?</h2>
                        	    <div class="new-user">
	                        	    <a class="btn btn-link" href="Sign Up.aspx">
	                        		    Register Now
	                        	    </a>
                        	    </div>
                            </div>
